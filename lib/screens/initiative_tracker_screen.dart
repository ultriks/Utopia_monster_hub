...
class _InitiativeTrackerScreenState extends State<InitiativeTrackerScreen> {
  ...
  void _showCombatantDialog({InitiativeEntry? existingEntry, int? existingIndex}) {
    final nameController = TextEditingController(text: existingEntry?.name ?? '');
    final initiativeController = TextEditingController(
      text: existingEntry != null ? existingEntry.initiativeScore.toString() : '',
    );
    ...
    final staminaController = TextEditingController(
      text: existingEntry != null ? existingEntry.currentStamina.toString() : '',
    );
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      decoration: const InputDecoration(labelText: 'Initiative Score'),
              ...
              actions: [
                ...
                TextButton(
                  onPressed: () {
                    ...
                    final initiative = int.tryParse(initiativeController.text) ?? 0;
          ...
          : ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return Dismissible(
                  ...
                  child: ListTile(
                    tileColor: isActive ? AppColors.primary.withValues(alpha: 0.2) : null,
                    title: Text(
                      entry.name,
                      style: TextStyle(fontWeight: isActive ? FontWeight.bold : FontWeight.normal),
                    ),
                    subtitle: Text('SHP: ${entry.currentShp} | DHP: ${entry.currentDhp} | STAM: ${entry.currentStamina}'),
